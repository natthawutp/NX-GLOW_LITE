...
export class WarehouseOptimizeService {
  ...
  generateLayoutFromDb(): Observable<AutoGeneratedLayoutResponse> {
    return this.api.post<AutoGeneratedLayoutResponse>(`${this.basePath}/layout/auto-generate`, {}).pipe(map(response => response.data));
  }
